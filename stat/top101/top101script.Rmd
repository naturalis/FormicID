...
g2 <-
    ...
    labs(title = "Species distribition per shottype") +
    coord_flip() +
...
final <- ggdraw() +
    ...
    draw_plot(g1, 0.43, 0.06, 0.5, 0.4) +
    draw_image(exampledata, 0.23, 0.17, scale = 0.50) +
    draw_plot_label(c("A", "B", "C"), c(0.05, 0.47, 0.47), c(1, 0.87, 0.46), size = 15)

# title <-
#     ggdraw() + draw_label("The dataset (cleaned)",
#                           size = 18,
#                           fontface = 'bold')
