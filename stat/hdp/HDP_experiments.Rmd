...
evo <- ggplot(total) + 
    geom_line(aes(x = Epoch, y = value, color = Accuracy), size = 1) + 
    facet_grid(~Shottype) + 
...
cms <- plot_grid(ggdorsal, gghead, ggprofile, ggstitched, nrow=2, ncol=2, labels = c("B     Dorsal", "C     Head", "D     Profile", "E     Stitched"))
