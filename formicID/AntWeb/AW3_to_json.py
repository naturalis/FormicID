...
"""
Description:
This file is outdated and needs an update. It is an sister of
`AW2_to_json.py`, but made to exploit AntWebs API version 3. As these
functions below are not fully working yet, you should use `AW2_to_json.py`.
"""
